...
export default class Application extends React.Component {
    ...
    return (
        ...
        <header className="mdl-layout__header">
          <div className="mdl-layout__header-row">
            ...
            <span className="mdl-layout__title">Anki-Battle-Showcase</span>
          </div>
        </header>
        <main className="mdl-layout__content">
          <div className="mdl-grid mdl-grid--full-height">
            <div id="visualization_panel" className="mdl-cell mdl-cell--9-col mdl-cell--8-col-tablet">
              <VisualizationPanel stomp={this.stomp} bodies={this.state.bodies} roadmap={this.state.roadmap}/>
            </div>
            <div className="mdl-cell mdl-cell--3-col mdl-cell--8-col-tablet">
              <CardPanel stomp={this.stomp} bodies={this.state.bodies} roadmap={this.state.roadmap} state={this.state.state}/>
            </div>
          </div>
        </main>
        <footer>
  ...
  componentDidMount() {
    ...
    connect(){
      this.socket = new SockJS('http://localhost:8080/inversiv');
    ...
    this.stomp.subscribe('/topic/bodies', this.stompDataReceived);
  ...
  stompDataReceived(data) {
      var bodies = JSON.parse(data.body);
